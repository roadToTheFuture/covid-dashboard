...
export default function renderMap(coordinates, casesInfo, countryName) {
  ...
  const mapApi = 'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibXlrb2xhLW5hemlta292IiwiYSI6ImNraXhnbHhuYTFyc3QzMm1tMzQ5eHA5ZHcifQ.I-eL5R52CFRxbUTbk79slQ';
